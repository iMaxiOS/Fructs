...
let fruitData: [Fruit] = [
    Fruit(
        title: "Blueberry",
        headline: "Blueberries are sweet, nutritious and wildly popular FruitModel all over the world.",
        image: "blueberry",
        ...
        description: """
          ...
          Blueberries are sold fresh or are processed as individually quick frozen (IQF) FruitModel, purée, juice, or dried or infused berries. These may then be used in a variety of consumer goods, such as jellies, jams, blueberry pies, muffins, snack foods, or as an additive to breakfast cereals.

          Blueberry jam is made from blueberries, sugar, water, and FruitModel pectin. Blueberry sauce is a sweet sauce prepared using blueberries as a primary ingredient.
      ...
      Fruit(
        ...
        description: """
          The garden strawberry (or simply strawberry; Fragaria × ananassa) is a widely grown hybrid species of the genus Fragaria, collectively known as the strawberries, which are cultivated worldwide for their FruitModel. The FruitModel is widely appreciated for its characteristic aroma, bright red color, juicy texture, and sweetness. It is consumed in large quantities, either fresh or in such prepared foods as jam, juice, pies, ice cream, milkshakes, and chocolates. Artificial strawberry flavorings and aromas are also widely used in products such as candy, soap, lip gloss, perfume, and many others.

          The strawberry is not, from a botanical point of view, a berry. Technically, it is an aggregate accessory FruitModel, meaning that the fleshy part is derived not from the plant's ovaries but from the receptacle that holds the ovaries.[4] Each apparent "seed" (achene) on the outside of the FruitModel is actually one of the ovaries of the flower, with a seed inside it.
      ...
      Fruit(
        ...
        description: """
          The lemon, Citrus limon, is a species of small evergreen tree in the flowering plant family Rutaceae, native to South Asia, primarily North eastern India. Its FruitModels are round in shape.

          The tree's ellipsoidal yellow FruitModel is used for culinary and non-culinary purposes throughout the world, primarily for its juice, which has both culinary and cleaning uses. The pulp and rind are also used in cooking and baking. The juice of the lemon is about 5% to 6% citric acid, with a pH of around 2.2, giving it a sour taste. The distinctive sour taste of lemon juice makes it a key ingredient in drinks and foods such as lemonade and lemon meringue pie.
          ...
          Lemons contain numerous phytochemicals, including polyphenols, terpenes, and tannins.[14] Lemon juice contains slightly more citric acid than lime juice (about 47 g/l), nearly twice the citric acid of grapeFruitModel juice, and about five times the amount of citric acid found in orange juice.

          CULINARY
          
          Lemon juice, rind, and peel are used in a wide variety of foods and drinks. The whole lemon is used to make marmalade, lemon curd and lemon liqueur. Lemon slices and lemon rind are used as a garnish for food and drinks. Lemon zest, the grated outer rind of the FruitModel, is used to add flavor to baked goods, puddings, rice, and other dishes.
      ...
      Fruit(
        title: "Plum",
        headline: "Plums are a very nutritious FruitModel. An excellent source of vitamins, minerals, fiber and antioxidants.",
        image: "plum",
        gradientColors: [Color("ColorPlumLight"), Color("ColorPlumDark")],
        description: """
          A plum is a FruitModel of the subgenus Prunus of the genus Prunus. The subgenus is distinguished from other subgenera (peaches, cherries, bird cherries, etc.) in the shoots having terminal bud and solitary side buds (not clustered), the flowers in groups of one to five together on short stems, and the FruitModel having a groove running down one side and a smooth stone (or pit).

          Mature plum FruitModel may have a dusty-white waxy coating that gives them a glaucous appearance. This is an epicuticular wax coating and is known as "wax bloom". Dried plum FruitModels are called "dried plums" or prunes, although, in many countries, prunes are a distinct type of dried plum having a wrinkled appearance (Li hing mui for instance).
          ...
          FruitModels are usually of medium size, between 2 and 7 centimetres in diameter, globose to oval. The flesh is firm and juicy. The FruitModel's peel is smooth, with a natural waxy surface that adheres to the flesh. The plum is a drupe, meaning its fleshy FruitModel surrounds a single hard seed.
          ...
          If the weather is too dry, the plums will not develop past a certain stage, but will fall from the tree while still tiny, green buds, and if it is unseasonably wet or if the plums are not harvested as soon as they are ripe, the FruitModel may develop a fungal condition called brown rot. Brown rot is not toxic, and some affected areas can be cut out of the FruitModel, but unless the rot is caught immediately, the FruitModel will no longer be edible. Plum is used as a food plant by the larvae of some Lepidoptera, including November moth, willow beauty and short-cloaked moth.

          The taste of the plum FruitModel ranges from sweet to tart; the skin itself may be particularly tart. It is juicy and can be eaten fresh or used in jam-making or other recipes. Plum juice can be fermented into plum wine. In central England, a cider-like alcoholic beverage known as plum jerkum is made from plums. Dried, salted plums are used as a snack, sometimes known as saladito or salao.
          ...
          A large number of plums, of the Damson variety, are also grown in Hungary, where they are called szilva and are used to make lekvar (a plum paste jam), palinka (traditional FruitModel brandy), plum dumplings, and other foods. In Romania, 80% of the plum production is used to create a similar brandy, called țuică.
          """,
      ...
      Fruit(
        title: "Lime",
        headline: "Sour, round, and bright green citrus FruitModels. Limes are high in vitamin C, antioxidants, and other nutrients.",
        image: "lime",
        gradientColors: [Color("ColorLimeLight"), Color("ColorLimeDark")],
        description: """
        A lime (from French lime, from Arabic līma, from Persian līmū, "lemon")[1] is a citrus FruitModel, which is typically round, green in color, 3–6 centimetres (1.2–2.4 in) in diameter, and contains acidic juice vesicles.

        There are several species of citrus trees whose FruitModels are called limes, including the Key lime (Citrus aurantiifolia), Persian lime, kaffir lime, and desert lime. Limes are a rich source of vitamin C, are sour, and are often used to accent the flavours of foods and beverages. They are grown year-round.[3] Plants with FruitModel called "limes" have diverse genetic origins; limes do not form a monophyletic group.
      ...
      Fruit(
        title: "Pomegranate",
        headline: "Sweet, bell-shaped FruitModels that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "pomegranate",
        gradientColors: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
        description: """
          The pomegranate (Punica granatum) is a FruitModel-bearing deciduous shrub in the family Lythraceae, subfamily Punicoideae, that grows between 5 and 10 m (16 and 33 ft) tall.
          ...
          The FruitModel is typically in season in the Northern Hemisphere from September to February, and in the Southern Hemisphere from March to May. As intact sarcotestas or juice, pomegranates are used in baking, cooking, juice blends, meal garnishes, smoothies, and alcoholic beverages, such as cocktails and wine.

          DESCRIPTION

          Red-purple in color, the pomegranate FruitModel husk has two parts: an outer, hard pericarp, and an inner, spongy mesocarp (white "albedo"), which comprises the FruitModel inner wall where seeds attach. Membranes of the mesocarp are organized as nonsymmetrical chambers that contain seeds inside sarcotestas, which are embedded without attachment to the mesocarp. Containing juice, the sarcotesta is formed as a thin membrane derived from the epidermal cells of the seeds. The number of seeds in a pomegranate can vary from 200 to about 1,400.

          Botanically, the edible FruitModel is a berry with seeds and pulp produced from the ovary of a single flower. The FruitModel is intermediate in size between a lemon and a grapeFruitModel, 5–12 cm (2–5 in) in diameter with a rounded shape and thick, reddish husk.

          CULTIVATION

          Pomegranate granatum is grown for its FruitModel crop, and as ornamental trees and shrubs in parks and gardens. Mature specimens can develop sculptural twisted-bark multiple trunks and a distinctive overall form. Pomegranates are drought-tolerant, and can be grown in dry areas with either a Mediterranean winter rainfall climate or in summer rainfall climates. In wetter areas, they can be prone to root decay from fungal diseases. They can be tolerant of moderate frost, down to about −12 °C (10 °F).

          Insect pests of the pomegranate can include the pomegranate butterfly Virachola isocrates and the leaf-footed bug Leptoglossus zonatus, and FruitModel flies and ants are attracted to unharvested ripe FruitModel. Pomegranate grows easily from seed, but is commonly propagated from 25 to 50 cm (10 to 20 in) hardwood cuttings to avoid the genetic variation of seedlings. Air layering is also an option for propagation, but grafting fails.
          """,
      ...
      Fruit(
        ...
        description: """
          The pear (/ˈpɛər/) tree and shrub are a species of genus Pyrus /ˈpaɪrəs/, in the family Rosaceae, bearing the pomaceous FruitModel of the same name. Several species of pear are valued for their edible FruitModel and juices while others are cultivated as trees.
          ...
          About 3000 known varieties of pears are grown worldwide. The FruitModel is consumed fresh, canned, as juice, and dried.
          ...
          For new varieties the flowers can be cross-bred to preserve or combine desirable traits. The FruitModel of the pear is produced on spurs, which appear on shoots more than one year old.

          Three species account for the vast majority of edible FruitModel production, the European pear Pyrus communis subsp. communis cultivated mainly in Europe and North America, the Chinese white pear (bai li) Pyrus ×bretschneideri, and the Nashi pear Pyrus pyrifolia (also known as Asian pear or apple pear), both grown mainly in eastern Asia. There are thousands of cultivars of these three species.
      ...
      Fruit(
        ...
        description: """
          ...
          One method of propagating gooseberries is by cuttings rather than raising from seed; cuttings planted in the autumn will take root quickly and can begin to bear FruitModel within a few years. Those growing from seeds will rapidly produce healthy heavily yielding bushes. Pruning should be carried out to allow light in and give the new growth for next year's branches an opportunity to grow. FruitModel is produced on lateral spurs and on the previous year's shoots.[13] The main aim is to let the light in and a subsidiary purpose is to allow picking without excessive scratching from the spines.

          Heavy nitrogen composting must be avoided as too much nitrogen will produce extensive growth and weaken the bush. This will make the bush susceptible to mildew. The FruitModel should best be picked off when large to reach maximum sweetness. Supermarkets tend to have theirs picked early and before they are ripe and sweet to give a long shelf life. Heavily laden branches should be cut off complete with berries, this really benefits future crops as it lets the light reach the new growth.

          CULINARY

          Gooseberries are edible and can be eaten as-is, or used as an ingredient in desserts, such as pies, fools and crumbles. Early pickings are generally sour and more appropriate for culinary use. They are also used to flavour beverages such as sodas, flavoured waters, or milk, and can be made into FruitModel wines and teas. Gooseberries can be preserved in the form of jams, dried FruitModel, or as the primary or a secondary ingredient in pickling, or stored in sugar syrup.
          """,
      ...
      Fruit(
        ...
        description: """
          A mango is a juicy stone FruitModel (drupe) produced from numerous species of tropical trees belonging to the flowering plant genus Mangifera, cultivated mostly for their edible FruitModel. Most of these species are found in nature as wild mangoes. The genus belongs to the cashew family Anacardiaceae. Mangoes are native to South Asia, from where the "common mango" or "Indian mango", Mangifera indica, has been distributed worldwide to become one of the most widely cultivated FruitModels in the tropics. Other Mangifera species (e.g. horse mango, Mangifera foetida) are grown on a more localized basis.

          Worldwide, there are several hundred cultivars of mango. Depending on the cultivar, mango FruitModel varies in size, shape, sweetness, skin color, and flesh color which may be pale yellow, gold, or orange. Mango is the national FruitModel of India and Pakistan, and the national tree of Bangladesh. It is the unofficial national FruitModel of the Philippines.

          DESCRIPTION

          Mango trees grow to 35–40 m (115–131 ft) tall, with a crown radius of 10 m (33 ft). The trees are long-lived, as some specimens still FruitModel after 300 years.[9] In deep soil, the taproot descends to a depth of 6 m (20 ft), with profuse, wide-spreading feeder roots and anchor roots penetrating deeply into the soil.[1] The leaves are evergreen, alternate, simple, 15–35 cm (5.9–13.8 in) long, and 6–16 cm (2.4–6.3 in) broad; when the leaves are young they are orange-pink, rapidly changing to a dark, glossy red, then dark green as they mature. The flowers are produced in terminal panicles 10–40 cm (3.9–15.7 in) long; each flower is small and white with five petals 5–10 mm (0.20–0.39 in) long, with a mild, sweet fragrance. Over 500 varieties of mangoes are known,[1] many of which ripen in summer, while some give a double crop. The FruitModel takes four to five months from flowering to ripen.
          ...
          The current world market is dominated by the cultivar 'Tommy Atkins', a seedling of 'Haden' that first FruitModeled in 1940 in southern Florida and was initially rejected commercially by Florida researchers.[22] Growers and importers worldwide have embraced the cultivar for its excellent productivity and disease resistance, shelf life, transportability, size, and appealing color.[23] Although the Tommy Atkins cultivar is commercially successful, other cultivars may be preferred by consumers for eating pleasure, such as Alphonso.

          Generally, ripe mangoes have an orange-yellow or reddish peel and are juicy for eating, while exported FruitModel are often picked while underripe with green peels. Although producing ethylene while ripening, unripened exported mangoes do not have the same juiciness or flavor as fresh FruitModel.
          """,
      ...
      Fruit(
        ...
        description: """
          Watermelon (Citrullus lanatus) is a plant species in the family Cucurbitaceae, a vine-like flowering plant originally domesticated in West Africa. It is a highly cultivated FruitModel worldwide, having more than 1000 varieties.

          Watermelon is a scrambling and trailing vine in the flowering plant family Cucurbitaceae. There is evidence from seeds in Pharaoh tombs of watermelon cultivation in Ancient Egypt. Watermelon is grown in favorable climates from tropical to temperate regions worldwide for its large edible FruitModel, which is a berry with a hard rind and no internal divisions, and is botanically called a pepo.

          The sweet, juicy flesh is usually deep red to pink, with many black seeds, although seedless varieties exist. The FruitModel can be eaten raw or pickled, and the rind is edible after cooking. It is commonly consumed as a juice or as an ingredient in mixed beverages.
          ...
          The white to yellow flowers grow singly in the leaf axils and the corolla is white or yellow inside and greenish-yellow on the outside. The flowers are unisexual, with male and female flowers occurring on the same plant (monoecious). The male flowers predominate at the beginning of the season; the female flowers, which develop later, have inferior ovaries. The styles are united into a single column. The large FruitModel is a kind of modified berry called a pepo with a thick rind (exocarp) and fleshy center (mesocarp and endocarp).

          Wild plants have FruitModels up to 20 cm (8 in) in diameter, while cultivated varieties may exceed 60 cm (24 in). The rind of the FruitModel is mid- to dark green and usually mottled or striped, and the flesh, containing numerous pips spread throughout the inside, can be red or pink (most commonly), orange, yellow, green or white.
      ...
      Fruit(
        ...
        description: """
          A cherry is the FruitModel of many plants of the genus Prunus, and is a fleshy drupe (stone FruitModel). Commercial cherries are obtained from cultivars of several species, such as the sweet Prunus avium and the sour Prunus cerasus.

          The name 'cherry' also refers to the cherry tree and its wood, and is sometimes applied to almonds and visually similar flowering trees in the genus Prunus, as in "ornamental cherry" or "cherry blossom". Wild cherry may refer to any of the cherry species growing outside cultivation, although Prunus avium is often referred to specifically by the name "wild cherry" in the British Isles.

          CULINARY

          The cultivated forms are of the species sweet cherry (P. avium) to which most cherry cultivars belong, and the sour cherry (P. cerasus), which is used mainly for cooking. Both species originate in Europe and western Asia; they usually do not cross-pollinate. Some other species, although having edible FruitModel, are not grown extensively for consumption, except in northern regions where the two main species will not grow.

          Irrigation, spraying, labor, and their propensity to damage from rain and hail make cherries relatively expensive. Nonetheless, demand is high for the FruitModel. In commercial production, sour cherries, as well as sweet cherries sometimes, are harvested by using a mechanized "shaker".[8] Hand picking is also widely used for sweet as well as sour cherries to harvest the FruitModel to avoid damage to both FruitModel and trees.
          ...
          A cherry tree will take three to four years once it is planted in the orchard to produce its first crop of FruitModel, and seven years to attain full maturity.
          """,
      ...
      Fruit(
        title: "GrapeFruitModel",
        headline: "Sweet, bell-shaped FruitModels that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "grapefruit",
        gradientColors: [Color("ColorGrapeFruitModelLight"), Color("ColorGrapeFruitModelDark")],
        description: """
          The grapeFruitModel (Citrus × paradisi) is a subtropical citrus tree known for its relatively large sour to semisweet, somewhat bitter FruitModel. GrapeFruitModel is a citrus hybrid originating in Barbados as an accidental cross between the sweet orange (C. sinensis) and pomelo (or shaddock; C. maxima), both of which were introduced from Asia in the 17th century.[2] When found, it was nicknamed the "forbidden FruitModel". Frequently, it is misidentified as the very similar parent species, pomelo.

          The "grape" part of the name alludes to clusters of FruitModel on the tree that often appear similar to grape clusters. The interior flesh is segmented and varies in color from white to yellow to pink to red.

          DESCRIPTION

          The evergreen grapeFruitModel trees usually grow to around 5–6 m (16–20 ft) tall, although they may reach 13–15 m (43–49 ft). The leaves are glossy, dark green, long (up to 15 cm (5.9 in)), and thin. It produces 5 cm (2 in) white four-petaled flowers. The FruitModel is yellow-orange skinned and generally, an oblate spheroid in shape; it ranges in diameter from 10 to 15 cm (3.9 to 5.9 in). The flesh is segmented and acidic, varying in color depending on the cultivars, which include white, pink, and red pulps of varying sweetness (generally, the redder varieties are the sweetest). The 1929 U.S. Ruby Red (of the 'Redblush' variety) has the first grapeFruitModel patent.

          CULINARY

          GrapeFruitModel varieties are differentiated by the flesh color of FruitModel they produce. Common varieties are red, white, and pink pulp colors. Flavors range from highly acidic and somewhat sour to sweet and tart, resulting from composition of sugars (mainly sucrose), organic acids (mainly citric acid), and monoterpenes and sesquiterpenes providing aromas.

          GrapeFruitModel mercaptan, a sulfur-containing terpene, is one of the aroma compounds influencing taste and odor of grapeFruitModel, compared with other citrus FruitModels.

          Raw grapeFruitModel is 90% water, 8% carbohydrates, 1% protein, and negligible fat (table). In a 100-g reference amount, raw grapeFruitModel provides 33 Calories and is a rich source of vitamin C (40% of the Daily Value), with no other micronutrients in significant content.

          In Costa Rica, especially in Atenas, grapeFruitModel are often cooked to remove their sourness, rendering them as sweets; they are also stuffed with dulce de leche, resulting in a dessert called toronja rellena (stuffed grapeFruitModel). In Haiti, grapeFruitModel is used primarily for its juice (jus de Chadèque), but also is used to make jam (confiture de Chadèque).
          """,
      ...
      Fruit(
        title: "Apple",
        headline: "Apples are one of the most popular, and exceptionally healthy FruitModel for good reason.",
        image: "apple",
        gradientColors: [Color("ColorAppleLight"), Color("ColorAppleDark")],
        description: """
          An apple is an edible FruitModel produced by an apple tree (Malus domestica). Apple trees are cultivated worldwide and are the most widely grown species in the genus Malus. The tree originated in Central Asia, where its wild ancestor, Malus sieversii, is still found today. Apples have been grown for thousands of years in Asia and Europe and were brought to North America by European colonists. Apples have religious and mythological significance in many cultures, including Norse, Greek and European Christian tradition.
          ...
          Blossoms are produced in spring simultaneously with the budding of the leaves and are produced on spurs and some long shoots. The 3 to 4 cm (1 to 1 1⁄2 in) flowers are white with a pink tinge that gradually fades, five petaled, with an inflorescence consisting of a cyme with 4–6 flowers. The central flower of the inflorescence is called the "king bloom"; it opens first and can develop a larger FruitModel.

          CULTIVATION

          There are more than 7,500 known cultivars of apples.[44] Cultivars vary in their yield and the ultimate size of the tree, even when grown on the same rootstock.[45] Different cultivars are available for temperate and subtropical climates. The UK's National FruitModel Collection, which is the responsibility of the Department of Environment, Food, and Rural Affairs, includes a collection of over 2,000 cultivars of apple tree in Kent.

          The UK's national FruitModel collection database contains much information on the characteristics and origin of many apples, including alternative names for what is essentially the same "genetic" apple cultivar. Most of these cultivars are bred for eating fresh (dessert apples), though some are cultivated specifically for cooking (cooking apples) or producing cider. Cider apples are typically too tart and astringent to eat fresh, but they give the beverage a rich flavor that dessert apples cannot.
